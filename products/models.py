...
class SubCategory(models.Model):
    ...
    category = models.ForeignKey(Category, verbose_name="Kategoriya", on_delete=models.CASCADE, related_name="subcategories")
...
class Product(models.Model):
    ...
    subcategory = models.ForeignKey(SubCategory, verbose_name='Subkategoriya', on_delete=models.CASCADE, related_name="products")
    manufacturer = models.ForeignKey(Manufacturer, verbose_name="Ishlab chiqaruvchi", on_delete=models.CASCADE, related_name="products")
    title = models.CharField(max_length=255, verbose_name='Nomi')
